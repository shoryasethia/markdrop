...
def analyze_pdf_images_main(
    source: str, output_dir: str, verbose: bool = False, save_images: bool = False
) -> dict[str, dict]:
    """
    ...
    try:
        ...
        with fitz.open(pdf_path) as doc:
                        ...
                        if save_images:
                            try:
                                ...
                                img_path = os.path.join(
                                    images_dir, f"page{page_num}_img{img_idx}_{xref}"
                                )
            ...
            markdown_refs = {
                k: {"count": v["count"], "xrefs": list(v["xrefs"])}
...
def analyze_pdf_images(
    source: str, output_dir: str, verbose: bool = True, save_images: bool = True
):
